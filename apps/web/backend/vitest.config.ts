  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        // to show the runtime starts, which is a different claim. app.ts is no
        // longer listed here: Issue #4 gave it routing and error-mapping
        // behavior, so app.medium.test.ts and the acceptance test now measure
        // it like any other src/ file.
        "src/index.ts",
      ],
    },
  },
